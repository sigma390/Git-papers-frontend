  ...
  return (
    ...
    <ToastContainer/>
     <div className=" shadow-lg shadow-slate-400 hover:scale-105 duration-200 signup-card ">
      <h2 className='text-2xl text-center hover:scale-110 duration-200' >Faculty Login</h2>
      ...
      <div className="input-group">
        ...
        <Link to='/reset-pass/faculty'  className=' mt-1 hover:text-orange-500 duration-200'  >Forgot Password ?</Link>
