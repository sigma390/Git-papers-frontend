...
const StudentLogin = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      dispatch(loginSuccess({ name: response.data.name, email: response.data.username }));
  ...
  return (
    ...
    <ToastContainer/>
     <div className=" shadow-lg shadow-slate-400 hover:scale-105 duration-200 signup-card ">
      <h2 className='text-2xl text-center hover:scale-110 duration-200' >Student Login</h2>
      ...
      <div className="input-group">
        ...
        <Link to='/reset-pass'  className=' mt-1 hover:text-orange-500 duration-200'  >Forgot Password ?</Link>
