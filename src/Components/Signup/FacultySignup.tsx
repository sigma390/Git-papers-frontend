...
export const baseURL = 'https://git-papers-backend-2.onrender.com/faculty';
...
const FacultySignup = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      dispatch(
        loginSuccess({ name: response.data.name, email: response.data.email })
      );
      ...
      <div className=' shadow-lg shadow-slate-400 hover:scale-105 duration-200 signup-card '>
        ...
        <div className='input-group'>
          ...
          <div className=' flex justify-between'>
            <button
              className=' mt-1 hover:text-orange-500 duration-200'
        ...
        <div className=' flex-row inline'>
          ...
          />
          <label className='ml-5' htmlFor='rememberMe'>
        ...
        <div className='flex mt-5 justify-center items-center'>
          <button
            className=' pb-1 w-32 flex p-2 bg-orange-700 
      rounded-xl justify-center items-center text-center
       text-xl text-white
        ...
        >
          ...
          <button className=' ml-2 text-blue-500'>Login Here</button>
        </div>
      </div>
    </>
  );
